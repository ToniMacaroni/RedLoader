...
namespace UnityGLTF
{
	public partial class GLTFSceneExporter
	{
		...
		private bool UseAnimationPointer
		{
			get
			{
				if (_useAnimationPointer == null)
					_useAnimationPointer = Enumerable.Any<GLTFExportPluginContext>(_plugins, x => x is AnimationPointerExportContext);
		...
		{
			GLTFSceneExporter.exportAnimationFromNodeMarker.Begin();
...
#endif
			GLTFSceneExporter.exportAnimationFromNodeMarker.End();
		}
		...
		public void RemoveUnneededKeyframes(ref float[] times, ref object[] values)
		{
			...
			GLTFSceneExporter.removeAnimationUnneededKeyframesMarker.Begin();
			...
			if (arraySize == 1)
			{
				...
				{
					GLTFSceneExporter.removeAnimationUnneededKeyframesCheckIdenticalMarker.Begin();
					...
					GLTFSceneExporter.removeAnimationUnneededKeyframesCheckIdenticalMarker.End();
				}
			...
			GLTFSceneExporter.removeAnimationUnneededKeyframesMarker.End();
		}
	}
}

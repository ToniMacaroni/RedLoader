...
public partial class GLTFSceneExporter
{
	...
	private AccessorId ExportAccessorUint(Vector4[] arr)
		{
			GLTFSceneExporter.exportAccessorMarker.Begin();
			GLTFSceneExporter.exportAccessorUintArrayMarker.Begin();
			...
			GLTFSceneExporter.exportAccessorBufferWriteMarker.Begin();
			...
			GLTFSceneExporter.exportAccessorBufferWriteMarker.End();
			...
			GLTFSceneExporter.exportAccessorUintArrayMarker.End();
			GLTFSceneExporter.exportAccessorMarker.End();
		...
		{
			GLTFSceneExporter.exportAccessorMarker.Begin();
			GLTFSceneExporter.exportAccessorVector4ArrayMarker.Begin();
			...
			GLTFSceneExporter.exportAccessorVector4ArrayMarker.End();
			GLTFSceneExporter.exportAccessorMarker.End();
		...
		{
			GLTFSceneExporter.exportAccessorMarker.Begin();
			GLTFSceneExporter.exportAccessorMatrix4x4ArrayMarker.Begin();
			...
			GLTFSceneExporter.exportAccessorMatrix4x4ArrayMarker.End();
			GLTFSceneExporter.exportAccessorMarker.End();
		...
		{
			GLTFSceneExporter.exportAccessorMarker.Begin();
			GLTFSceneExporter.exportAccessorByteArrayMarker.Begin();
			...
			GLTFSceneExporter.exportAccessorByteArrayMarker.End();
			GLTFSceneExporter.exportAccessorMarker.End();
		...
		{
			GLTFSceneExporter.exportAccessorMarker.Begin();
			GLTFSceneExporter.exportAccessorFloatArrayMarker.Begin();
			...
			GLTFSceneExporter.exportAccessorMinMaxMarker.Begin();
			var min = arr[0];
			var max = arr[0];
			...
			GLTFSceneExporter.exportAccessorMinMaxMarker.End();
			...
			GLTFSceneExporter.exportAccessorFloatArrayMarker.End();
			GLTFSceneExporter.exportAccessorMarker.End();
		...
		{
			GLTFSceneExporter.exportAccessorMarker.Begin();
			if (isIndices) GLTFSceneExporter.exportAccessorIntArrayIndicesMarker.Begin(); else GLTFSceneExporter.exportAccessorIntArrayMarker.Begin();
			...
			if (isIndices) GLTFSceneExporter.exportAccessorIntArrayIndicesMarker.End(); else GLTFSceneExporter.exportAccessorIntArrayMarker.End();
			GLTFSceneExporter.exportAccessorMarker.End();
		...
		{
			GLTFSceneExporter.exportAccessorMarker.Begin();
			GLTFSceneExporter.exportAccessorVector2ArrayMarker.Begin();
			...
			GLTFSceneExporter.exportAccessorVector2ArrayMarker.End();
			GLTFSceneExporter.exportAccessorMarker.End();
		...
		{
			GLTFSceneExporter.exportAccessorMarker.Begin();
			GLTFSceneExporter.exportAccessorVector3ArrayMarker.Begin();
			...
			GLTFSceneExporter.exportAccessorVector3ArrayMarker.End();
			GLTFSceneExporter.exportAccessorMarker.End();
		...
		{
			GLTFSceneExporter.exportSparseAccessorMarker.Begin();
			...
			GLTFSceneExporter.exportSparseAccessorMarker.End();
		...
		{
			GLTFSceneExporter.exportAccessorMarker.Begin();
			GLTFSceneExporter.exportAccessorColorArrayMarker.Begin();
			...
			GLTFSceneExporter.exportAccessorColorArrayMarker.End();
			GLTFSceneExporter.exportAccessorMarker.End();

...
namespace UnityGLTF.Extensions
{
	public static class SchemaExtensions
	{
		...
		public static void GetUnityTRSProperties(this Node node, out UnityEngine.Vector3 position, out Quaternion rotation,
		...
		/// <param name="rotation">unity rotation quaternion</param>
		/// <param name="scale">unity scale vector</param>
		public static void GetTRSProperties(this Matrix4x4 mat, out UnityEngine.Vector3 position, out Quaternion rotation,
			out UnityEngine.Vector3 scale)
		{
			position = mat.GetColumn(3);

			UnityEngine.Vector3 x = mat.GetColumn(0);
			UnityEngine.Vector3 y = mat.GetColumn(1);
			UnityEngine.Vector3 z = mat.GetColumn(2);
			UnityEngine.Vector3 calculatedZ = UnityEngine.Vector3.Cross(x, y);
			bool mirrored = UnityEngine.Vector3.Dot(calculatedZ, z) < 0.0f;

			scale = new UnityEngine.Vector3(x.magnitude * (mirrored ? -1.0f : 1.0f), y.magnitude, z.magnitude);
		...
		/// <param name="rotation">unity rotation quaternion</param>
		/// <param name="scale">unity scale vector</param>
		public static void GetTRSProperties(this Math.Matrix4x4 gltfMat, out UnityEngine.Vector3 position, out Quaternion rotation,
			out UnityEngine.Vector3 scale)
		{
		...
		/// <returns></returns>
		public static Vector4 GetColumn(this Math.Matrix4x4 mat, uint columnNum)
		{
			switch (columnNum)
			{
				case 0:
		...
		public static Quaternion ToUnityQuaternionConvert(this Math.Quaternion gltfQuat)
		{
			UnityEngine.Vector3 fromAxisOfRotation = new UnityEngine.Vector3(gltfQuat.X, gltfQuat.Y, gltfQuat.Z);
			float axisFlipScale = CoordinateSpaceConversionRequiresHandednessFlip ? -1.0f : 1.0f;
			UnityEngine.Vector3 toAxisOfRotation = axisFlipScale * UnityEngine.Vector3.Scale(fromAxisOfRotation, CoordinateSpaceConversionScale.ToUnityVector3Raw());
		...
		{
			UnityEngine.Vector3 fromAxisOfRotation = new UnityEngine.Vector3(quat.value.x, quat.value.y, quat.value.z);
			float axisFlipScale = CoordinateSpaceConversionRequiresHandednessFlip ? -1.0f : 1.0f;
			UnityEngine.Vector3 toAxisOfRotation = axisFlipScale * UnityEngine.Vector3.Scale(fromAxisOfRotation, CoordinateSpaceConversionScale.ToUnityVector3Raw());
		...
		{
			UnityEngine.Vector3 fromAxisOfRotation = new UnityEngine.Vector3(quat.x, quat.y, quat.z);
			float axisFlipScale = CoordinateSpaceConversionRequiresHandednessFlip ? -1.0f : 1.0f;
			UnityEngine.Vector3 toAxisOfRotation = axisFlipScale * UnityEngine.Vector3.Scale(fromAxisOfRotation, CoordinateSpaceConversionScale.ToUnityVector3Raw());
		...
		public static Math.Quaternion ToGltfQuaternionConvert(this Quaternion unityQuat)
		{
			UnityEngine.Vector3 fromAxisOfRotation = new UnityEngine.Vector3(unityQuat.x, unityQuat.y, unityQuat.z);
			float axisFlipScale = CoordinateSpaceConversionRequiresHandednessFlip ? -1.0f : 1.0f;
			UnityEngine.Vector3 toAxisOfRotation = axisFlipScale * UnityEngine.Vector3.Scale(fromAxisOfRotation, CoordinateSpaceConversionScale.ToUnityVector3Raw());

			return new Math.Quaternion(toAxisOfRotation.x, toAxisOfRotation.y, toAxisOfRotation.z, unityQuat.w);
		}
		...
		public static Matrix4x4 ToUnityMatrix4x4Convert(this Math.Matrix4x4 gltfMat)
		{
			Matrix4x4 rawUnityMat = gltfMat.ToUnityMatrix4x4Raw();
			UnityEngine.Vector3 coordinateSpaceConversionScale = CoordinateSpaceConversionScale.ToUnityVector3Raw();
		...
		public static Math.Matrix4x4 ToGltfMatrix4x4Convert(this Matrix4x4 unityMat)
		{
			UnityEngine.Vector3 coordinateSpaceConversionScale = CoordinateSpaceConversionScale.ToUnityVector3Raw();
			Matrix4x4 convert = Matrix4x4.Scale(coordinateSpaceConversionScale);
			Math.Matrix4x4 gltfMat = (convert * unityMat * convert).ToGltfMatrix4x4Raw();
			return gltfMat;
		}
		...
		public static UnityEngine.Vector3 ToUnityVector3Convert(this Vector3 gltfVec3)
		{
			UnityEngine.Vector3 coordinateSpaceConversionScale = CoordinateSpaceConversionScale.ToUnityVector3Raw();
			UnityEngine.Vector3 unityVec3 = UnityEngine.Vector3.Scale(gltfVec3.ToUnityVector3Raw(), coordinateSpaceConversionScale);
			return unityVec3;
		}
		...
		/// <param name="gltfVec3">gltf vector3</param>
		/// <returns>unity vector3</returns>
		public static UnityEngine.Vector3 ToUnityVector3Convert(this float3 gltfVec3)
		{
			UnityEngine.Vector3 coordinateSpaceConversionScale = CoordinateSpaceConversionScale.ToUnityVector3Raw();
			UnityEngine.Vector3 unityVec3 = UnityEngine.Vector3.Scale(gltfVec3.ToUnityVector3Raw(), coordinateSpaceConversionScale);
			return unityVec3;
		...
		public static void ToUnityVector3Convert(this float3[] vec3, UnityEngine.Vector3[] arr, int offset)
		{
		...
		public static Vector3 ToGltfVector3Convert(this UnityEngine.Vector3 unityVec3)
		{
			UnityEngine.Vector3 coordinateSpaceConversionScale = CoordinateSpaceConversionScale.ToUnityVector3Raw();
			Vector3 gltfVec3 = UnityEngine.Vector3.Scale(unityVec3, coordinateSpaceConversionScale).ToGltfVector3Raw();
			return gltfVec3;
		}

		public static Vector3 ToGltfVector3Raw(this UnityEngine.Vector3 unityVec3)
		{
			Vector3 gltfVec3 = new Vector3(unityVec3.x, unityVec3.y, unityVec3.z);
			return gltfVec3;
		}
		
		public static Vector4 ToGltfVector4Raw(this UnityEngine.Vector4 unityVec4)
		{
			Vector4 gltfVec4 = new Vector4(unityVec4.x, unityVec4.y, unityVec4.z, unityVec4.w);
			return gltfVec4;
		}

		public static Matrix4x4 ToUnityMatrix4x4Raw(this Math.Matrix4x4 gltfMat)
		{
			UnityEngine.Vector4 rawUnityCol0 = gltfMat.GetColumn(0).ToUnityVector4Raw();
			UnityEngine.Vector4 rawUnityCol1 = gltfMat.GetColumn(1).ToUnityVector4Raw();
			UnityEngine.Vector4 rawUnityCol2 = gltfMat.GetColumn(2).ToUnityVector4Raw();
			UnityEngine.Vector4 rawUnityCol3 = gltfMat.GetColumn(3).ToUnityVector4Raw();
		...
		{
			UnityEngine.Vector4 rawUnityCol0 = gltfMat.c0.ToUnityVector4Raw();
			UnityEngine.Vector4 rawUnityCol1 = gltfMat.c1.ToUnityVector4Raw();
			UnityEngine.Vector4 rawUnityCol2 = gltfMat.c2.ToUnityVector4Raw();
			UnityEngine.Vector4 rawUnityCol3 = gltfMat.c3.ToUnityVector4Raw();
			Matrix4x4 rawUnityMat = new UnityEngine.Matrix4x4();
			rawUnityMat.SetColumn(0, rawUnityCol0);
			rawUnityMat.SetColumn(1, rawUnityCol1);
			rawUnityMat.SetColumn(2, rawUnityCol2);
		...
		public static Math.Matrix4x4 ToGltfMatrix4x4Raw(this Matrix4x4 unityMat)
		{
			Vector4 c0 = unityMat.GetColumn(0).ToGltfVector4Raw();
			Vector4 c1 = unityMat.GetColumn(1).ToGltfVector4Raw();
			Vector4 c2 = unityMat.GetColumn(2).ToGltfVector4Raw();
			Vector4 c3 = unityMat.GetColumn(3).ToGltfVector4Raw();
			Math.Matrix4x4 rawGltfMat = new Math.Matrix4x4(c0.X, c0.Y, c0.Z, c0.W, c1.X, c1.Y, c1.Z, c1.W, c2.X, c2.Y, c2.Z, c2.W, c3.X, c3.Y, c3.Z, c3.W);
			return rawGltfMat;
		}

		public static Vector2 ToUnityVector2Raw(this Math.Vector2 vec2)
		{
		...
		public static Vector2[] ToUnityVector2Raw(this Math.Vector2[] inVecArr)
		{
		...
		public static UnityEngine.Vector3 ToUnityVector3Raw(this Vector3 vec3)
		{
			return new UnityEngine.Vector3(vec3.X, vec3.Y, vec3.Z);
		}

		public static UnityEngine.Vector3 ToUnityVector3Raw(this float3 vec3)
		{
			return new UnityEngine.Vector3(vec3.x, vec3.y, vec3.z);
		}
		...
		public static UnityEngine.Vector3[] ToUnityVector3Raw(this float3[] vec3)
		{
			var r = new UnityEngine.Vector3[vec3.Length];
			for (int i = 0; i < vec3.Length; i++)
			{
		...
		public static void ToUnityVector3Raw(this float3[] vec3, UnityEngine.Vector3[] arr, int offset)
		{
			for (int i = 0; i < vec3.Length; i++)
			{
		...
		public static UnityEngine.Vector4 ToUnityVector4Raw(this Vector4 vec4)
		{
			return new UnityEngine.Vector4(vec4.X, vec4.Y, vec4.Z, vec4.W);
		}

		public static UnityEngine.Vector4 ToUnityVector4Raw(this float4 vec4)
		{
			return new UnityEngine.Vector4(vec4.x, vec4.y, vec4.z, vec4.w);
		}		
		...
		public static UnityEngine.Vector4[] ToUnityVector4Raw(this float4[] vec4)
		{
			var r = new UnityEngine.Vector4[vec4.Length];
		...
		public static void ToUnityVector4Raw(this float4[] vec4, UnityEngine.Vector4[] arr, int offset)
		{
			for (int i = 0; i < vec4.Length; i++)
			{
		...
		public static UnityEngine.Color ToUnityColorRaw(this Color color)
		{
			var c = new UnityEngine.Color(color.R, color.G, color.B, color.A).gamma;
			return c;
		}

		public static void ToUnityColorRaw(this float4[] inArr, UnityEngine.Color[] outArr, int offset)
		{
		...
		public static UnityEngine.Color ToUnityColorLinear(this Color color)
		{
			var c = new UnityEngine.Color(color.R, color.G, color.B, color.A);
			return c;
		}

		public static void ToUnityColorLinear(this float4[] inArr, UnityEngine.Color[] outArr, int offset)
		{
			for (int i = 0; i < inArr.Length; i++)
			{
		...
		public static UnityEngine.Color ToUnityColorGamma(this Color color)
		{
			var c = new UnityEngine.Color(color.R, color.G, color.B, color.A).linear;
			return c;
		}

		public static Color ToNumericsColorRaw(this UnityEngine.Color color)
		{
			var c = color;
			return new Color(c.r, c.g, c.b, c.a);
		}

		public static Color ToNumericsColorLinear(this UnityEngine.Color color)
		{
			var lc = color.linear;
			return new Color(lc.r, lc.g, lc.b, lc.a);
		}
		
		public static Color ToNumericsColorGamma(this UnityEngine.Color color)
		{
			var lc = color.gamma;
			return new Color(lc.r, lc.g, lc.b, lc.a);
		}

		public static Color[] ToNumericsColorLinear(this UnityEngine.Color[] inColorArr)
		{
		...
		public static UnityEngine.Color[] ToLinear(this Il2CppStructArray<UnityEngine.Color> inColorArr)
		{
			UnityEngine.Color[] outColorArr = new UnityEngine.Color[inColorArr.Length];
			for (int i = 0; i < inColorArr.Length; ++i)
			{
		...
		public static void ToUnityColorRaw(this Color[] inArr, UnityEngine.Color[] outArr, int offset = 0)
		{
			for (int i = 0; i < inArr.Length; i++)
			{
		...
		public static void ToUnityColorLinear(this Color[] inArr, UnityEngine.Color[] outArr, int offset = 0)
		{
			for (int i = 0; i < inArr.Length; i++)
			{
		...
		public static Math.Quaternion ToGltfQuaternionRaw(this Quaternion unityQuat)
		{
			return new Math.Quaternion(unityQuat.x, unityQuat.y, unityQuat.z, unityQuat.w);
		}
		...
		public static UnityEngine.Vector3[] ConvertVector3CoordinateSpaceAndCopy(UnityEngine.Vector3[] array, Vector3 coordinateSpaceCoordinateScale)
		{
		...
		/// <param name="coordinateSpaceCoordinateScale">The specified coordinate space</param>
		/// <returns>The copied and converted coordinate space</returns>
		public static UnityEngine.Vector4[] ConvertVector4CoordinateSpaceAndCopy(UnityEngine.Vector4[] array, Vector4 coordinateSpaceCoordinateScale)
		{
			var returnArray = new UnityEngine.Vector4[array.Length];
		...
		/// <param name="coordinateSpaceCoordinateScale">The specified coordinate space</param>
		/// <returns>The copied and converted coordinate space</returns>
		public static UnityEngine.Vector4[] ConvertTangentCoordinateSpaceAndCopy(UnityEngine.Vector4[] array, Vector4 coordinateSpaceCoordinateScale)
		{
			var returnArray = new UnityEngine.Vector4[array.Length];
			var coordinateScale = coordinateSpaceCoordinateScale.ToUnityVector4Raw();
		...
		public static Matrix4x4 ToUnityMatrix4x4(this Math.Matrix4x4 matrix)
		{
		...
		public static Matrix4x4[] ToUnityMatrix4x4(this Math.Matrix4x4[] inMatrixArr)
		{

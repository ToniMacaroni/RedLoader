...
public class CustomFreeCam : MonoBehaviour
{
    ...
    static CustomFreeCam()
    {
        ClassInjector.RegisterTypeInIl2Cpp<CustomFreeCam>();
    }
	...
	private void OnEnable()
	{
        ...
        _globalMouseSensitivity = 0.2f;//Config.LookSensitivty.Value;
        _positionLerpTime = 0.5f;//Config.PositionalSmoothing.Value;
        _rotationLerpTime = 0.01f;//Config.RotationalSmoothing.Value;
        _mouseYMultiplier = 0.7f;//Config.MouseYRatio.Value;

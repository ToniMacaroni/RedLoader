...
namespace SFLoader
{
    public abstract class MelonBase
    {
        ...
        public static void PrintIncompatibilities(Incompatibility[] incompatibilities, MelonBase melon)
        {
            ...
            // {
            //     MelonLogger.MsgDirect($"- {melon.Info.Name}  is only compatible with the following SFLoader Versions:");
            ...
            // {
            //     MelonLogger.MsgDirect($"- {melon.Info.Name} is only compatible with the following SFLoader Build Hash Codes:");

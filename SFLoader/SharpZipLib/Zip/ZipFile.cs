...
using System.Text;
using SFLoader.ICSharpCode.SharpZipLib.Checksum;
using SFLoader.ICSharpCode.SharpZipLib.Core;
using SFLoader.ICSharpCode.SharpZipLib.Encryption;
using SFLoader.ICSharpCode.SharpZipLib.Zip.Compression;
using SFLoader.ICSharpCode.SharpZipLib.Zip.Compression.Streams;

namespace SFLoader.ICSharpCode.SharpZipLib.Zip
{
	...
	/// using System.IO;
	///
	/// using SFLoader.ICSharpCode.SharpZipLib.Zip;
	///
	/// class MainClass
	/// {

...
internal class ConsoleWindow
{
    ...
    public static void Attach()
    {
        ...
        if (OriginalStdoutHandle != IntPtr.Zero && ConsoleManager.ConfigConsoleOutRedirectType ==
    ...
    public static void SetConsolePos(IntPtr hWndInsertAfter, int X, int Y, int cx, int cy, UInt32 uFlags)
    {

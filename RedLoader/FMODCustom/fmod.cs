    ...
    */
    public class System : HandleBase
    {
        ...
        */
        ...
        [DllImport("fmodstudio")]
        public static extern RESULT FMOD_System_CreateSound            (IntPtr system, byte[] name_or_data, MODE mode, ref CREATESOUNDEXINFO exinfo, out IntPtr sound);
        [DllImport("fmodstudio")]

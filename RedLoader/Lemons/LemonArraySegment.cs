...
namespace RedLoader
{
    ...
    public class LemonArraySegment<T> : IList<T>, ICollection<T>, IEnumerable<T>, IEnumerable
    {
        ...
        /// <returns>The original array that was passed to the constructor, and that contains the range delimited by the <see cref="T:RedLoader.LemonArraySegment`1" />.</returns>
        ...
        /// <returns>The position of the first element in the range delimited by the <see cref="T:RedLoader.LemonArraySegment`1" />, relative to the start of the original array.</returns>
        public int Offset { get; private set; }

        /// <summary>Gets the number of elements in the range delimited by the array segment.</summary>
        /// <returns>The number of elements in the range delimited by the <see cref="T:RedLoader.LemonArraySegment`1" />.</returns>
        public int Count { get; private set; }

        /// <summary>Initializes a new instance of the <see cref="T:RedLoader.LemonArraySegment`1" /> structure that delimits all the elements in the specified array.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="T:RedLoader.LemonArraySegment`1" /> structure that delimits the specified range of the elements in the specified array.</summary>
		...
		/// <returns>
		///   <see langword="true" /> if the specified object is a <see cref="T:RedLoader.LemonArraySegment`1" /> structure and is equal to the current instance; otherwise, <see langword="false" />.</returns>
		public override bool Equals(object obj)
            => obj is LemonArraySegment<T> && Equals((LemonArraySegment<T>)obj);

        /// <summary>Determines whether the specified <see cref="T:RedLoader.LemonArraySegment`1" /> structure is equal to the current instance.</summary>
        /// <param name="obj">The structure to compare with the current instance.</param>
        /// <returns>
        ///   <see langword="true" /> if the specified <see cref="T:RedLoader.LemonArraySegment`1" /> structure is equal to the current instance; otherwise, <see langword="false" />.</returns>
        public bool Equals(LemonArraySegment<T> obj)
            => obj.Array == Array && obj.Offset == Offset && obj.Count == Count;

		/// <summary>Indicates whether two <see cref="T:RedLoader.LemonArraySegment`1" /> structures are equal.</summary>
		...
		/// <summary>Indicates whether two <see cref="T:RedLoader.LemonArraySegment`1" /> structures are unequal.</summary>

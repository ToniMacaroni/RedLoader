...
using System.Text;
using RedLoader.ICSharpCode.SharpZipLib.Checksum;
using RedLoader.ICSharpCode.SharpZipLib.Core;
using RedLoader.ICSharpCode.SharpZipLib.Encryption;
using RedLoader.ICSharpCode.SharpZipLib.Zip.Compression;
using RedLoader.ICSharpCode.SharpZipLib.Zip.Compression.Streams;

namespace RedLoader.ICSharpCode.SharpZipLib.Zip
{
	...
	/// using System.IO;
	///
	/// using RedLoader.ICSharpCode.SharpZipLib.Zip;
	///
	/// class MainClass
	/// {
